...
const LeadFilters = ({ searchTerm, setSearchTerm, statusFilter, setStatusFilter }) => {
  return (
    <div className="bg-white p-4 sticky top-0 z-40 border-b border-gray-100 space-y-3">
      <h1 className="text-xl font-black text-gray-800 uppercase tracking-tighter">My Assignments</h1>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="relative">
          <FilterIcon className="absolute left-3 top-3 text-gray-400" size={16} />
          <select 
